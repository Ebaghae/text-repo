...
companies['Years To Unicorn'] = Year_Joined - companies['Year Founded']
...
# [One row in the table has a negative years to unicorn value. It is for Invision company.]
...
# [The result shows some mispellings in Industry values that do not match the spellings in the list]
...
# [It makes the variable an ordinal variable.]
