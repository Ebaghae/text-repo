...
#note that when making these comparison, each variable must have its own argument, also do not put them in quotes.
...
#note that each argument is in their own parenthesis.
#also dataframe used '&' instead of 'and'. using 'and' throws an error.
#other operators include; '|' instead of 'or' and '~' instaed or 'not'
