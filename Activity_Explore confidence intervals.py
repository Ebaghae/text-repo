...
rre_states = ['California', 'Ohio', 'Texas', 'Michigan', 'Florida', 'Pennsylvania']

# Subset `aqi` to only consider these states.
rre_data = aqi[aqi['state_name'].isin(rre_states)]

# Find the mean aqi for each of the RRE states.
rre_data.groupby(['state_name']).mean()
...
### YOUR CODE HERE ###
sns.boxplot(x=rre_data['state_name'], y=rre_data['aqi'])
...
# California and Michigan would be most affected by the policie because they have aqi values ranging from 10 and above
...
### YOUR CODE HERE ###
mask = aqi['state_name'] == 'California'
aqi_ca = aqi[(mask)]
